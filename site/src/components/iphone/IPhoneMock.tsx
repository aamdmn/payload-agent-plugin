...
import { isDemoMuted, onDemoMuteChange, toggleDemoMute } from "./mute-store";

/*
 * iPhone 17 Pro frame. The screen is a clip-path window; children render into a
 * fixed 418x890 content box that is scaled to fit the device cutout, so the chat
 * UI keeps pixel-exact proportions at any display scale. Ported from caltext.
 */
const SCREEN_PATH =
